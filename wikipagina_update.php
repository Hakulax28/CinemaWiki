    ...
    <form action="wikipagina_update.php?page_id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
      <div class="containerWikipage container">
        <div class="main">
          ...
          <div class="mainText">
            <div class="">
              <textarea class="form-control" id="Textarea1" name="pageMainText" rows="5" maxlength="5000" value="<?php echo $film["pageMainText"] ?>"></textarea>
            </div>
          </div>
          <div class="mainImage">
        ...
        <div class="sidebar">
          ...
          <div class="sideText">
            <div class="">
              <textarea class="form-control" name="pageSidebarText" id="Textarea2" rows="5" maxlength="5000" value="<?php echo $film["pageSidebarText"] ?>"></textarea>
            </div>
          </div>
        </div>
        ...
        <div class="sections">
          <div class="section1Title">
            <div class="mb-3S">
              <input type="text" class="form-control" id="section1Title" name="pageSection1Title" placeholder="section1Title" value="<?php echo $film["section1Title"] ?>">
            </div>
          </div>

          <div class="section1MainText">
            <div class="">
              <textarea class="form-control" id="Textarea3" rows="5" name="pageSection1Text1" maxlength="5000" value="<?php echo $film["pageSection1Text1"] ?>">Section 1 Text</textarea>
            </div>
          </div>
          ...
          <div class="section1ExtraText">
            <div class="">
              <textarea class="form-control" id="Textarea4" name="pageSection1Text2" rows="5" maxlength="5000" value="<?php echo $film["pageSection1Text2"] ?>">Section 1 Extra Text</textarea>
            </div>
          </div>

          <div class="section2Title">
            <div class="mb-3S">
              <input type="text" class="form-control" id="section2Title" name="pageSection2Title" placeholder="section2Title" value="<?php echo $film["pageSection2Title"] ?>">
            </div>
          </div>

          <div class=" section2MainText">
            <div class="">
              <textarea class="form-control" name="pageSection2Text" id="Textarea4" rows="5" maxlength="5000" value="<?php echo $film["pageSection2Text"] ?>">Section 2 Text</textarea>
            </div>
          </div>
        </div>
        ...
        <div class="sources">
          <div class="">
            <textarea class="form-control" name="pageSources" id="Textarea5" rows="5" maxlength="5000" value="<?php echo $film["pageSources"] ?>">Sources Text</textarea>
          </div>
        </div>
      </div>
